CREATE DATABASE IF NOT EXISTS INFO_MAIS;
USE INFO_MAIS;
...
NOME_OPCAO VARCHAR(50) NOT NULL UNIQUE,
VALOR_FORMULARIO VARCHAR(50) NOT NULL UNIQUE
);
...
VALOR_FORMULARIO VARCHAR(50) NOT NULL UNIQUE,
ID_OPCAO_FK INT NOT NULL,
FOREIGN KEY (ID_OPCAO_FK) REFERENCES INTERESSE(ID_OPCAO)
);
...
ID_SUBCATEGORIA_FK INT NOT NULL,
FOREIGN KEY (ID_SUBCATEGORIA_FK) REFERENCES SUBCATEGORIA(ID_SUBCATEGORIA)
);
...
INSERT INTO SUBCATEGORIA (ID_OPCAO_FK, NOME_SUBCATEGORIA, VALOR_FORMULARIO) VALUES
...
(5, 'Literatura e Livros', 'literatura_ent'),
...
(5, 'Teatro e Musicais', 'teatro_musicais');
...
(6, 'Arqueologia', 'arqueologia_ciencia'),
...
(9, 'Criptomoedas e Ativos Digitais', 'criptomoedas_neg'),
...
(10, 'Desenvolvimento Pessoal', 'desenvolvimento_personal'),
